...
#include "HAL/MallocScaled.h" // Just my malloc;
...
FMalloc* FWindowsPlatformMemory::BaseAllocator()
{
	...
	else if (USE_SCALED_MALLOC)
	{
		AllocatorToUse = EMemoryAllocatorToUse::Scaled;
	}
#if PLATFORM_64BITS
	...
	case EMemoryAllocatorToUse::Ansi:
		...
		break;
	case EMemoryAllocatorToUse::Scaled:
		Instance = new FMallocScaled();
		break;
#if WITH_MALLOC_STOMP
