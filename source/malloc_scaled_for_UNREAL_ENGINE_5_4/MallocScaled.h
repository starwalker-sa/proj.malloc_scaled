...
//	|__________| <--*
...
#endif
		TMallocScaledVMBlock PoolVMBlock;
	};
	...
	public:
		TMemPoolTableEntry()
		{
			Initialized = false;
			SubIndexCount = 0;
			MaxSubIndexCount = MALLOC_SCALED_MAX_SUBINDEX_COUNT;
		}

		bool Init(SIZE_T InBaseIndex, SIZE_T InMinBaseBlockSize, SIZE_T InMaxBaseBlockSize, SIZE_T InPoolBlockSize, uint32 InSubIndexCount);
		void Free();
	...
	class TMemPoolTable
	{
		...
		private:
			...
			TMallocScaledVMBlock DataBlock;
	...
	public:
		...
		static SIZE_T GetPoolIndex(SIZE_T BlockSize, SIZE_T BaseIndex, SIZE_T MinBaseIndex, SIZE_T PoolIndexCount);

		bool Init(SIZE_T InMinBaseBlockSize, SIZE_T InMaxBaseBlockSize, SIZE_T InPoolBlockSize, uint32 InSubIndexCount);
		void Free();
